...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--source", required=True, type=str,
                        help="Input file containing 'source' terms to map to ontology terms")
    parser.add_argument("-t", "--target", required=True, type=str,
                        help="Path or URL of 'target' ontology to map the source terms to. When the chosen mapper is "
    ...
    parser.add_argument("-m", "--mapper", required=False, type=str, default=Mapper.TFIDF,
                        help="Mapping method to use. One of: " + str(Mapper.list()) + " (default=tfidf)")
    ...
    parser.add_argument("-iris", "--base_iris", required=False, type=str, default=(),
                        help="Map only to ontology terms whose IRIs start with a value given in this comma-separated list")
    ...
    parser.add_argument("-g", "--save_term_graphs", required=False, default=False, action="store_true",
                        help="Save the graphs representing the neighborhood of each ontology term (default=False)")
    ...
    Text2Term().map(arguments.source, arguments.target, output_file=arguments.output, csv_columns=csv_columns,
